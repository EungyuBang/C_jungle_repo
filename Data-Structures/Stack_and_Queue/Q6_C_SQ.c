...
////////////////////////////////////////////////////////////
/*
	스택에서 선택된 값의 첫 번째 발생을 만날 때까지 모든 값을 팝(pop) 하는 C 함수 작성
	예시: 스택 (1, 2, 3, 4, 5, 6, 7)에서 value = 4로 호출하면 스택 (4, 5, 6, 7)이 됨 (1, 2, 3이 팝됨).
*/
/*
	로직 생각 
	1. 스택 비어있는 경우 처리
	2. 스택이 비어있지 않다면 그냥 반복문 돌리면서 peek(s) != value 면 pop하다가 peek(s) == value 면 break 하면 되는거 아녀?
*/
void removeUntil(Stack *s, int value)
{
/* add your code here */
